export const AstariaV1BorrowerEnforcerABI = [
  {
    inputs: [
      {
        internalType: 'bytes',
  ...
  {
    inputs: [],
    name: 'AmountExceedsCaveatCollateral',
    type: 'error',
  },
  {
    inputs: [],
    name: 'BorrowerOnlyEnforcer',
    type: 'error',
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: 'LoanAmountOutOfBounds',
    type: 'error',
  },
  {
    inputs: [],
    name: 'LoanRateExceedsCurrentRate',
    type: 'error',
  },
  {
    inputs: [],
    name: 'MinAmountExceedsMaxAmount',
    type: 'error',
  },
  {
    inputs: [],
