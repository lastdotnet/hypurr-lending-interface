export const AstariaV1RatioLenderEnforcerABI = [
  {
    inputs: [],
    name: 'BelowMinCollateralAmount',
    type: 'error',
  },
  {
    inputs: [],
    name: 'CollateralBundlesNotSupported',
    type: 'error',
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: 'MaxDebtOrCollateralToDebtRatioZero',
    type: 'error',
  },
  {
    inputs: [],
