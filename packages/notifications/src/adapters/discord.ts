import { type IAdapter, type NotificationType, type SendMessageParams } from '../types'
import { Adapter } from './adapter'

const { NEXT_DISCORD_EVENT_WEBHOOK = '', NEXT_DISCORD_WARNINGS_WEBHOOK = '' } = process.env
...
class DiscordAdapter extends Adapter implements IAdapter {
  ...
  protected emojies = {
    error: '[![Error](https://cdn3.emoji.gg/emojis/4934-error.png)](https://emoji.gg/emoji/4934-error)',
    'internal-critical':
      '[![warning](https://cdn3.emoji.gg/emojis/2109-warning.png)](https://emoji.gg/emoji/2109-warning)',
    'internal-info': '[![info](https://cdn3.emoji.gg/emojis/3228-info.png)](https://emoji.gg/emoji/3228-info)',
    'user-info':
  ...
  protected sendMessage = async (type: NotificationType, message: SendMessageParams) => {
    const { text } = message
