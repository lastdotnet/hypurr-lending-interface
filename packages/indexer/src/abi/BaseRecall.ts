...
export const functions = {
  ...
  recall: new Func<
    ...
    []
  >(abi, '0xf02a9e14'),
  recalls: new Func<[_: bigint], {}, [recaller: string, start: bigint] & { recaller: string; start: bigint }>(
    abi,
    '0xbf1efc73',
  ),
...
export class Contract extends ContractBase {
  ...
  recalls(arg0: bigint): Promise<[recaller: string, start: bigint] & { recaller: string; start: bigint }> {
