...
export const events = {
  ...
  CaveatNonceIncremented: new LogEvent<[owner: string, newNonce: bigint] & { newNonce: bigint; owner: string }>(
    abi,
    '0xe8e5dfdf538b2dfce2d1f2dff7bc7ec9c962a7ffa5249ae7a3673468b72d067e',
  ),
  CaveatSaltInvalidated: new LogEvent<[owner: string, salt: string] & { owner: string; salt: string }>(
    abi,
    '0xf6477e1235adf3e2d7737f3b3eb64d5faf363d83c5d0fb6659cee58d22d22d99',
  ),
  ...
  Paused: new LogEvent<[]>(abi, '0x9e87fac88ff661f02d44f95383c817fece4bce600a3dab7a54406878b965e752'),
  Unpaused: new LogEvent<[]>(abi, '0xa45f47fdea8a1efdd9029a5691c7f759c32b7c698632b563573e155625d16933'),
}
...
export const functions = {
  ...
  closed: new Func<[loanId: bigint], { loanId: bigint }, boolean>(abi, '0x5c959b62'),
  completeOwnershipHandover: new Func<[pendingOwner: string], { pendingOwner: string }, []>(abi, '0xf04e283e'),
  ...
  hashCaveatWithSaltAndNonce: new Func<
    [
      ...
      salt: string,
      deadline: bigint,
      caveats: Array<[enforcer: string, data: string] & { data: string; enforcer: string }>,
    ],
    {
      account: string
      caveats: Array<[enforcer: string, data: string] & { data: string; enforcer: string }>
  ...
  invalidSalts: new Func<[_: string, _: string], {}, boolean>(abi, '0x81679fde'),
  invalidateCaveatSalt: new Func<[salt: string], { salt: string }, []>(abi, '0xb3b588aa'),
  loanState: new Func<[_: bigint], {}, bigint>(abi, '0x49b274ed'),
  open: new Func<[loanId: bigint], { loanId: bigint }, boolean>(abi, '0x690e7c09'),
  originate: new Func<
    [
      additionalTransfers: Array<
        [itemType: number, token: string, from: string, to: string, identifier: bigint, amount: bigint] & {
          amount: bigint
          from: string
          identifier: bigint
          itemType: number
  ...
  ownershipHandoverExpiresAt: new Func<[pendingOwner: string], { pendingOwner: string }, bigint>(abi, '0xfee81cf4'),
  ...
  setFeeOverride: new Func<
    ...
    []
  >(abi, '0x891569aa'),
  setOriginateApproval: new Func<[who: string, approvalType: number], { approvalType: number; who: string }, []>(
    abi,
    '0x8990a835',
  ),
  settle: new Func<
    ...
    []
  >(abi, '0x52107d30'),
  transferOwnership: new Func<[newOwner: string], { newOwner: string }, []>(abi, '0xf2fde38b'),
...
export class Contract extends ContractBase {
  ...
  applyRefinanceConsiderationToLoan(
    ...
    >
  > {
    return this.eth_call(functions.applyRefinanceConsiderationToLoan, [considerationPayment, carryPayment])
  }
  ...
  hashCaveatWithSaltAndNonce(
    ...
    return this.eth_call(functions.hashCaveatWithSaltAndNonce, [account, singleUse, salt, deadline, caveats])
  }
