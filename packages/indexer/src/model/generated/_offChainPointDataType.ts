...
export type OffChainPointDataType =
  | CheckedIntentFeedData
  | IntentSubmissionData
  | IntentFillData;

export function fromJsonOffChainPointDataType(
  json: any
): OffChainPointDataType {
  switch (json?.isTypeOf) {
    ...
    default:
      throw new TypeError(
        'Unknown json object passed as OffChainPointDataType'
      );
  }
}
