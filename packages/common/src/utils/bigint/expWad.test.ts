...
describe('expWad', () => {
  ...
  it('should calculate expWad correctly', () => {
    ...
    expect(expWad(BigInt(50e18))).toBe(
      5184705528587072464148529318587763226117n
    ); // 5184705528587072464148529318587763226117n

    expect(expWad(BigInt(100e18))).toBe(
      26881171418161354484134666106240937146178367581647816351662017n
    ); // 26881171418161354484134666106240937146178367581647816351662017n
