import { milliseconds, millisecondsToHours, millisecondsToMinutes, millisecondsToSeconds } from 'date-fns'
...
const outputDuration = ({
  ...
  if (!duration.days) {
    ...
    if (duration.seconds && duration.seconds > 0 && (!concise || (concise && !duration.hours && !duration.minutes))) {
