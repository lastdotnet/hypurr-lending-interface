...
} as Meta<typeof PercentInput>

const Story: StoryFn<typeof PercentInput> = (args) => (
  <div className="grid w-full max-w-sm items-center gap-1.5">
    <Label htmlFor="input">Input</Label>
    <PercentInput id="input" {...args} />
  </div>
)
...
const ControlledStory: StoryFn<typeof PercentInput> = (args) => {
      ...
      <form id="testForm" noValidate>
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <PercentInput {...field} id="input" {...args} />
                <FormMessage />
              </FormItem>
            )}
          />
...
export const controlledPercentInput = {
  args: {},
