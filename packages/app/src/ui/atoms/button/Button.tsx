...
export const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded border border-slate-700 border-opacity-10 font-semibold text-base ring-offset-background transition-colors disabled:pointer-events-none disabled:bg-slate-700 disabled:bg-opacity-10 disabled:text-white/70 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
  {
    variants: {
      ...
      size: {
        sm: 'h-8 gap-1 rounded px-3 py-2 text-xs',
        md: 'h-10 gap-1.5 rounded px-4 py-2',
        lg: 'h-14 gap-2.5 rounded px-6 py-4',
        undefined: '',
      },
      spaceAround: {
        none: 'h-auto p-0',
