...
export function TopBanner({ onClose }: TopBannerProps) {
  return (
    <div className="fixed top-0 right-0 left-0 z-50 flex w-full flex-col items-center justify-center gap-2 bg-primary-bg p-2 text-center text-body text-sm sm:flex-row">
      <p className="px-10">
